...
COPY parche_leantime/class.editUser.php /var/www/html/src/domain/users/controllers/class.editUser.php
COPY parche_leantime/es-ES.ini /var/www/html/resources/language/es-ES.ini
